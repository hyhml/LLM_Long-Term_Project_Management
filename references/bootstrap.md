...
- initial nodes and relations for the project map;
...
Report the created path, validation result, initial revision, and the explicit invocation name. Do not claim that the project is initialized if validation fails.

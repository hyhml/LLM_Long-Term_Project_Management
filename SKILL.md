...
9. Project tasks have exactly two priorities: `high` and `low`. Work on confirmed high-priority tasks first unless the user explicitly selects a low-priority task. Never promote, demote, add, or close a task without a proposed change and user confirmation.
